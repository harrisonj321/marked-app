...
/**
 * The Google/email sign-in controls -- deliberately just a fragment of
 * actions, not a screen. Home embeds this directly inside its own
 * guest-state main content, so authenticating happens inside the real app
 * shell rather than a separate standalone auth page.
 */
export function SignInActions({ authError = null }: SignInActionsProps) {
